			...
			<form class="qodef-deactivation-modal-form" method="post">
				...
				<div class="qodef-deactivation-modal-form-options">
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-no_longer_needed" class="qodef-deactivation-modal-form-option-label"><?php esc_html_e( 'I no longer need the plugin', 'qode-wishlist-for-woocommerce' ); ?></label>
					</div>
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-found_a_better_plugin" class="qodef-deactivation-modal-form-option-label"><?php esc_html_e( 'I found a better plugin', 'qode-wishlist-for-woocommerce' ); ?></label>
					...
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-couldnt_get_plugin_to_work" class="qodef-deactivation-modal-form-option-label"><?php esc_html_e( 'I couldn\'t get plugin to work', 'qode-wishlist-for-woocommerce' ); ?></label>
					</div>
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-temporary_deactivation" class="qodef-deactivation-modal-form-option-label"><?php esc_html_e( 'This is a temporary deactivation', 'qode-wishlist-for-woocommerce' ); ?></label>
					</div>
					<div class="qodef-deactivation-modal-form-option">
					...
					<div class="qodef-deactivation-modal-form-option">
						...
						<label for="qodef-deactivation-modal-form-option-other" class="qodef-deactivation-modal-form-option-label"><?php esc_html_e( 'Other', 'qode-wishlist-for-woocommerce' ); ?></label>
