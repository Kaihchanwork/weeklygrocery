...
if(!function_exists('bridge_qode_set_plugins_array_to_install')){
	function bridge_qode_set_plugins_array_to_install(){
		...
		$default_plugins_array_to_install = array( 'js_composer', 'elementor', 'bridge-core', 'LayerSlider', 'revslider', 'envato-market', 'qode-twitter-feed', 'qode-instagram-widget', 'qi-addons-for-elementor', 'qi-blocks', 'qode-wishlist-for-woocommerce', 'qode-quick-view-for-woocommerce', 'leadin' );
	}
	...
	function bridge_qode_plugins_list($filter_array = array()){
		$plugins = array(
			...
			array(
				...
				'slug'     				=> 'LayerSlider',
				'source'   				=> get_template_directory() . '/plugins/layersliderwp-7.11.0.installable.zip',
				'required' 				=> false,
				'version' 				=> '7.11.0',
				'force_activation' 		=> false,
				'force_deactivation' 	=> false,
